...
class ImageProcessingTests(unittest.TestCase):
    ...
    def test_hcm0204_notebook_owns_runtime_config(self) -> None:
        ...
        self.assertIn("vai_cleaned", config["data_root"])
        self.assertNotIn("vai_native_simple_radial", config["data_root"])
        self.assertIn(
            "hfgs_edge_scale_improvedgs_30k_5m5_dense00025",
            config["output_root"],
        )
        ...
        self.assertIn(
            "HF-GS edge + scale trên ImprovedGS thuần, dense 0.00025, 30k, budget 5.5M",
            all_notebook_source,
        )
