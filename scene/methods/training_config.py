...
def build_training_method_config(opt: Any) -> dict[str, Any]:
    ...
    soft_density_scale = _read_bool(opt, "soft_density_scale", False)
    if soft_density_scale and method not in ("improvedgs", "gns"):
        raise ValueError("soft_density_scale is supported only with improvedgs or gns.")
    ...
    return {
        ...
        "use_mu": use_mu,
        "use_rap": use_rap,
        "soft_density_scale": soft_density_scale,
    }
